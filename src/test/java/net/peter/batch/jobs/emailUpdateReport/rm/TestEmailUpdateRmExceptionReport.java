...
@ContextConfiguration(classes = { TestConfigs.class, EmailUpdateRmExceptionReport.class, TestConfigs4Ftp.class })
@ActiveProfiles({ ProfileNames.TEST, ProfileNames.CONFIG_DEV })
public class TestEmailUpdateRmExceptionReport {
	...
	private static final String CSV_FILE_NAME = EmailUpdateRmExceptionReport.FTP_FOLDER + File.separator + "EmailUpdateRmExceptionReport.csv";
	...
	private void insert(MyDate date, String email, String code, String message) {
		...
		sql.insertInto(DSL.table("TBL_PB_PREFERENCE_ESB_RESP"))
			...
			.set(DSL.field("CC_RESPONSE_CODE", String.class), "00")
			...
			.set(DSL.field("RM_RESPONSE_CODE", String.class), code)
