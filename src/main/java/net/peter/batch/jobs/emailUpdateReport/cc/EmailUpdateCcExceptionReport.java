...
@JobConfiguration
public class EmailUpdateCcExceptionReport extends AbstractJob {

	private static final String JOB_NAME = "EmailUpdateCcExceptionReport";
	...
	private static final String SELECT_SQL = "classpath:com/cncbinternational/batch/jobs/emailUpdateReport/cc/EmailUpdateCcExceptionReport.sql";
