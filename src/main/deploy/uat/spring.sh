JavaHome="/u01/jdk1.8.0_72"
JARFile="IbBatchJobs.war"
PIDFile="app.pid"
SPRING_OPTS="-Dspring.profiles.active=ConfigUat,HostReal,EsbReal"
...
nohup $JavaHome/bin/java $SPRING_OPTS -jar $JARFile &
